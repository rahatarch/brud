import { executeFileOperations, FileOperation, validateWorkspacePath, executeTerminalCommand, executeCommand, executeSequential } from '@brud/core';
...
export async function executeOperationsFromVSCode(
  ...
  return executeFileOperations(operations, fs, workspaceFolders, historyStore, originalPrompt, { execute: executeTerminalCommand, executeCommand, executeSequential }, sessionIdOverride);
}